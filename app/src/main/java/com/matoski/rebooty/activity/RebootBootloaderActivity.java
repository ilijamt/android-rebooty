 ...
 *
 */
public class RebootBootloaderActivity extends BaseActivity {
	...
	protected void dialogClickedYes() {
		...
		intent.setAction(Constants.KEY_ACTION_BOOTLOADER);
		startService(intent);		
	}
	...
	protected void setupStrings() {
		...
		this.dialogTitle = R.string.reboot_bootloader;
		this.dialogMessage = R.string.reboot_bootloader_message;
